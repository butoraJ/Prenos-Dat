  ...
  <body>
     <div id="div_psw">
      ...
      <div id="div_logintextfield">
        ...
        <form method="post" action="http://localhost:8080/user/sign">
            <div  style="margin-top: 2px;">
            	...
            	<br>
                Heslo znova: <br>
                <input type="password" name="psw2" required  style="width: 60%"> 
            	<br>
                <br>
                <input type="submit" value="Registrovať " style="width: 60%; margin-right: 2%; height:30px; border-radius: 15px">
            </div>
	</form>
